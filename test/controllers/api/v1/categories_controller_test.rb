...
class Api::V1::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_category" do
    assert_difference("Api::V1::Category.count") do
      post api_v1_categories_url, params: { api_v1_category: { name: @api_v1_category.name, publish: @api_v1_category.publish, slug: @api_v1_category.slug, sort: @api_v1_category.sort } }, as: :json
    end
  ...
  test "should update api_v1_category" do
    patch api_v1_category_url(@api_v1_category), params: { api_v1_category: { name: @api_v1_category.name, publish: @api_v1_category.publish, slug: @api_v1_category.slug, sort: @api_v1_category.sort } }, as: :json
    assert_response :success
  end
